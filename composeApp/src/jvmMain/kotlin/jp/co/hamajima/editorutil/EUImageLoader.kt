...
fun EUImageLoader(): ImageBitmap { // JVM-specific image loading implementation
    ...
    val chooser = JFileChooser().apply {
        ...
        currentDirectory = File( settings.getString("lastImageDir", System.getProperty("user.home")) )
    }
    ...
    // 最後に開いたディレクトリを保存
    settings.putString("lastImageDir", file.parentFile?.absolutePath ?: System.getProperty("user.home"))
